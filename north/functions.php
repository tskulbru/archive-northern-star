...
?>
<font face="tahoma" size="1">Northern* VS <? echo $opponent; ?></font><br>
...
<a href="matches.php">Back to matches page</a>.<br>
...
<p><img border="0" src="images/northernstartop.jpg" width="503" height="17"></p>
<? if(isset($_COOKIE['online']) && ($_COOKIE['user_lvl'] >= 8)){
	echo "<font face=\"tahoma\" size=\"1\"><a href=\"index2.php?action=addmatch\">[Add match]</a> <a href=\"index2.php?action=editmatch\">[Edit match]</a></font>";
}
...
$query4 = "SELECT count(*) as ant_lostmatches FROM matches WHERE us < them";
$result4 = mysql_query($query4) or die ("Feil: ".mysql_error());

while($r=mysql_fetch_array($result4)){
 $ant_lostmatches = $r['ant_lostmatches'];
}
...
?>
      ...
      <table width="100%" cellspacing="0" cellpadding="0" border="0">
        ...
        <tr> 
          <td valign="top">&nbsp; <font face="tahoma" size="1">Matches lost:</font></td>
          <td valign="top"><font face="tahoma" size="1"> 
            <? echo $ant_lostmatches; ?>
            .</font></td>
        </tr>
        <tr> 
